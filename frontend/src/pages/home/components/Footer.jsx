...
const Footer = () => {
    return (
        <footer class="bg-gray-100 p-8">
            <div class="grid md:grid-cols-4 gap-8">
                <div>
                    <div class="flex items-center space-x-2">
                        ...
                        <h1 class="text-2xl font-bold text-gray-800">ZenEd</h1>
                    </div>
                    <p class="text-gray-600 mt-4">A modern learning platform designed for everyone.</p>
                    <div class="flex space-x-4 mt-4 text-gray-600">
                        ...
                        <a class="hover:text-primary" href="#"><svg aria-hidden="true" class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path clip-rule="evenodd" d="M12 2C6.477 2 2 6.477 2 12c0 4.237 2.636 7.855 6.356 9.312-.062-.327-.019-1.03.048-1.514.056-.411.355-.705.355-.705s-.098.39-.098.84c0 .76.47 1.33.987 1.33.917 0 1.258-1.042.853-1.631-.247-.362-.63-.918-.63-1.953 0-1.458 1.04-2.71 2.923-2.71 1.543 0 2.59 1.156 2.59 2.518 0 .975-.333 1.953-.78 2.85-.362.74-.954 1.396-1.944 1.396-.556 0-1.05-.286-1.229-.623 0 0-.256-1.03-.32-1.291-.09-.37-.506-.99-.506-1.442 0-.96.533-1.809 1.631-1.809.878 0 1.55.766 1.55 1.838 0 .618-.114 1.234-.306 1.732-.153.407-.153.84 0 1.243.203.546.577 1.096 1.159 1.096.917 0 1.758-.996 1.758-2.983 0-1.644-1.159-2.883-3.261-2.883-2.22 0-3.696 1.672-3.696 3.498 0 .684.223 1.18.223 1.18s-.696 2.94-1.03 4.223C5.106 20.347 4.19 18.067 4.19 15.655 4.19 9.874 7.632 6 12.313 6c3.12 0 5.161 2.21 5.161 5.111 0 3.322-2.025 5.56-4.945 5.56-.996 0-1.896-.533-1.896-1.18" fill-rule="evenodd"></path></svg></a>
                    </div>
                </div>
                <div>
                    <h5 class="font-bold text-gray-800">About</h5>
                    <ul class="mt-4 space-y-2 text-gray-600">
                        <li><a class="hover:text-primary" href="#">About Us</a></li>
                        <li><a class="hover:text-primary" href="#">Careers</a></li>
                        <li><a class="hover:text-primary" href="#">Press &amp; Blogs</a></li>
                        <li><a class="hover:text-primary" href="#">Become an Instructor</a></li>
                    </ul>
                </div>
                <div>
                    <h5 class="font-bold text-gray-800">Support</h5>
                    <ul class="mt-4 space-y-2 text-gray-600">
            ...
            <div class="mt-8 border-t pt-6 text-center text-gray-500 text-sm">
